...
|서비스|주요 기능|
|---------------|----------------|
|회원 서비스|JWT 기반 로그인 <br/> 소셜 로그인 및 회원가입|
|게시판 서비스|상품 문의,상품 리뷰, 고객문의 게시판 등록, 수정, 삭제 <br/> 게시글 잠금 등록|
|상품 서비스|카테고리 및 가격별 상품 조회 <br/> 상품 등록/상품 수정/상품 삭제|
|사용자 마이페이지|회원정보 조회/수정/삭제 <br/> 작성글 조회/수정/삭제 <br/> 장바구니 조회/수정/삭제 <br/> 찜리스트 조회/수정/삭제 <br/> 주문, 결제 내역 조회/취소 신청 <br/> 배송지 정보 관리|
|관리자 페이지|매출 현황 그래프/문의글 관리 및 댓글 작성/상품 관리/주문, 결제 관리|
<br/>
